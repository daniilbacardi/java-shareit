...
public interface ItemService {
    Collection<ItemDtoResponse> getAllItemsOfUser(long userId, Integer from, Integer size);

    ItemDtoResponse getItemById(long userId, long itemId);

    Collection<ItemDto> searchAnItem(String text, Integer from, Integer size);
