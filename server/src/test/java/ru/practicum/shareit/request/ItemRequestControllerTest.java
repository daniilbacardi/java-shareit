...
class ItemRequestControllerTest {
    ...
    @BeforeEach
    void setUp() {
        itemRequestDto = TestData.request;
    }

    @Test
    void createNewRequestTest() throws Exception {
        ShortRequestDto shortRequestDto = new ShortRequestDto("description");
        when(requestService.createNewRequest(anyLong(), any())).thenReturn(itemRequestDto);
    ...
    @Test
    void getListOfUserRequestsTest() throws Exception {
    ...
    @Test
    void getListOfRequestsTest() throws Exception {
