...
class ItemServiceImplTest {
    ...
    @BeforeAll
    static void setUp() {
        user = new User(1, "name", "user1@mail.ru");
    ...
    void getAllItemsOfUserTest() {
        ...
        Collection<ItemDtoResponse> result = itemService.getAllItemsOfUser(1L, 0, 20);
    ...
    void createNewItemTest() {
        ...
        ItemDto result = itemService.createNewItem(itemDto, 1);
        assertNotNull(result);
