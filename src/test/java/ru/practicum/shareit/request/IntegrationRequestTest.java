...
import static ru.practicum.shareit.TestData.request;
import static ru.practicum.shareit.TestData.requester;
...
class IntegrationRequestTest {
    ...
    public void getUserByIdTest() {
        UserDto savedRequester = userService.createNewUser(requester);
        ShortRequestDto shortRequestDto = new ShortRequestDto("description");
        ItemRequestDto savedRequest = requestService.createNewRequest(savedRequester.getId(), shortRequestDto);
